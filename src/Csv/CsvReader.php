...
final class CsvReader
{
    public function read(string $filePath, CsvOptions $options): RawTable
    {
        ...
        if ($this->fileStartsWithUtf8Bom($filePath)) {
            $file->fseek(3);
        }
    ...
    private function fileStartsWithUtf8Bom(string $filePath): bool
    {
        return str_starts_with($this->readRawSample($filePath), "\xEF\xBB\xBF");
    }
